...
import { CustomOutputBasic } from "../audio/custom-output-basic";
import { SettingsNode } from "./settings-node";
...
export class AzureTtsNode extends HTMLElement {
      ...
      .pipe(
        ...
        concatMap(async (block) => {
          ...
          const result = await synthesizeSpeech({
            apiKey: connection.azureSpeechKey,
            region: connection.azureSpeechRegion,
            text: block.text,
